...
class Timetable(Base):
    ...
    dep_sem_course_id = Column(Integer, ForeignKey("dwarka.dep_sem_course.id", ondelete="CASCADE"))
    course_component_id = Column(Integer, ForeignKey("dwarka.course_component.id", ondelete="CASCADE"))  # ✅ Fixed

    room_id = Column(Integer, ForeignKey("dwarka.rooms.room_id"))
    faculty_id = Column(Integer, ForeignKey("dwarka.faculty.faculty_id"))
